...
script_version('1.3')
script_description('СМИ-хелпер Аризона РП')
script_author('fa1ser')

--made with love by fa1ser
...
local tag = '{008080}[News Helper by fa1ser]: {C0C0C0}'
local tmp = {['downKey'] = {}}
...
function imgui.WindowMain() -- Основное окно
	imgui.BeginChild(id_name..'child_7', imgui.ImVec2(imgui.GetWindowWidth() - 195, 180), false, 0)
		imgui.TextWrapped('Скрипт помощник для работником Средств Массовой Информации. Сделан по многочисленным просьбам, для удобства сотрудников СМИ г.Сан-Фиерро с сервера Scottdale. Скрипт нацелен именно на помощь, а не автоматизацию. Функции "Бота" тут отсутствуют, скрипт легален. На других серверах данный скрипт должен быть разрешен, но лучше уточняйте у своих главных администраторов, разработчик за блокировку вашего аккаунта ответственности не несет.\n\nНа данный момент скрипт находится на тестировании - все кнопки, интерфейс, система могут быть переделаны.\nСпасибо Vova Kabanos, scope за идею ;)')
	imgui.EndChild()
end
...
function imgui.EventDescription() -- раздел мер. эфир. Описание
	...
	imgui.BeginChild(id_name..'child_window_23', imgui.ImVec2(imgui.GetWindowWidth() - 40, imgui.GetWindowHeight() - 38), false)
		...
		imgui.TextWrapped('Если у Вас что-либо не работает, пишите мне в вк vk.com/fa1ser')
	imgui.EndChild()
end
...
function loadVar()
	...
	newsHelpBind = {
		{'Покупка домов',
			...
			{'Продам машину','Продам а/м "". Бюджет: '},
			{'Куплю машину','Куплю а/м "". Бюджет: '},
			{'Куплю машину любой марки','Куплю а/м любой марки. Бюджет: '},
			{'Продам мотоцикл','Продам м/ц "". Цена: '},
			{'Куплю мотоцикл','Куплю м/ц "". Бюджет: '},
			{'Куплю мотоцикл любой марки','Куплю м/ц любой марки. Бюджет: '},
			{'Продам лодку', 'Продам л/д "". Цена: '},
			{'Куплю лодку', 'Куплю л/д "". Бюджет: '},
			{'Куплю лодку любой марки', 'Куплю л/д любой марки. Бюджет: '},
			{'Продам самолет', 'Продам с/т "". Цена: '},
			{'Куплю самолет', 'Куплю с/т "". Бюджет: '},
			{'Куплю самолет любой марки', 'Куплю с/т любой марки. Бюджет: '},
			{'Продам вертолет', 'Продам в/т "". Цена: '},
			{'Куплю вертолет', 'Куплю в/т "". Бюджет: '},
			{'Куплю вертолет любой марки', 'Куплю в/т любой марки. Бюджет: '},
			{'Продам фуру', 'Продам г/м "". Цена: '},
			{'Куплю фуру', 'Куплю г/м "". Бюджет: '},
			{'Куплю фуру любой марки', 'Куплю г/м любой марки. Бюджет: '}
			...
			{'Куплю бизнес любой','Куплю б/з любого типа в любой точке штата. Бюджет: '},
			{'Продам бизнес в СФ','Продам б/з * в г. Сан-Фиерро. Цена: '},
			{'Куплю бизнес в СФ','Куплю б/з в г. Сан-Фиерро. Бюджет: '},
			{'Продам бизнес','Продам б/з * №* . Цена:'},
			{'Продам бизнес в ЛВ','Продам б/з * в г Лас-Вентурас. Цена: '},
			{'Куплю бизнес в ЛВ','Куплю б/з в г. Лас-Вентурас. Бюджет: '},
			{'Продам бизнес в ФК','Продам б/з * в д. Форт-Карсон. Цена: '},
			{'Куплю бизнес в ФК','Куплю б/з в д. Форт-Карсон. Бюджет: '},
		},{'Покупка/продажа аксессуаров/одежды',
			{'Куплю аксик','Куплю а/с "". Бюджет: '},
			{'Продам аксик','Продам а/с "". Цена: '},
			{'Куплю аксик с заточкой','Куплю а/с "" с грав-ой *. Бюджет: '},
			{'Продам аксик с заточкой','Продам а/с "" с грав-ой *. Цена: '},
			{'Куплю скин любой','Куплю о/п любого типа. Бюджет: '},
			{'Куплю скин *','Куплю о/п "". Бюджет: '},
			{'Продам скин','Продам о/п "". Цена: '}
		},{'Охранники',
			{'Продам охранника *','Продам услуги охранника "". Цена:'},
			{'Куплю охранника *','Куплю услуги охранника "". Бюджет:'},
			{'Продам охранника с доп зп','Продам услуги охранника с нашивкой "+зп ". Цена: '},
			{'Куплю охранника с доп зп','Куплю услуги охранника с нашивкой "+зп ". Бюджет: '},
		},{'Реклама бизнесов',
			...
			{'Warlok MC','Проходит собеседование в бар "Бородатая Фея". Ждем Вас'},
			{'LCN','Проходит набор в ЧВК "Карбон". Встреча у особняка'},
			{'Yakuza','Проходит собеседование в японский ресторан. Ждем вас'},
			...
			{'ПД','Хочешь бороться с преступностью? Тогда тебе на собеседование в полицию г. '},
			{'МЗ','Хочешь стать доктором и помогать людям? Устраивайся в больницу г. '},
			{'ДТЛ','Нравится давать людям новые знания? Тогда тебе на собеседование в ДТЛ'},
			...
			{'СК', 'Хочешь много зарабатывать? Устраивайся в Страховую Компанию'},
			{'Пра-во','Вы всегда хотели работать с бумагами? Тогда Вам к нам на собеседование в Мэрию'}
		},{'Семьи',
			{'Со всеми Улучшений', 'Семья "" со всеми нашивками ищет дальних родственников. Просьба связаться'},
			{'Без Улучшений', 'Семья * ищет дальних родственников. Просьба связаться'},
			...
			{'Куплю семейные талоны (кол-во)','Куплю р/с "Семейные талоны" в кол-ве * штук. Бюджет: '},
			{'Продам семейные талоны (кол-во)','Продам р/с "Семейные талоны" в кол-ве * штук. Цена: */шт'}
			...
			{'Куплю гражданские талоны (кол-во)','Куплю р/с "Гражданские талоны" в кол-ве * штук. Бюджет: '},
			{'Продам гражданские талоны (кол-во)','Продам р/с "Гражданские талоны" в кол-ве * штук. Цена: */шт'}
			...
			{'Куплю телефон','Куплю т/ф фирмы "". Бюджет:'},
			{'Продам телефон ','Продам т/ф фирмы "". Цена: '},
			{'Куплю модификацию(мод) ','Куплю м/ф "". Бюджет:'},
			{'Продам модификацию(мод) ','Продам м/ф "". Цена:'}
		},{'Покупка/продажа видеокарт, смазок и охлаждаек',
			{'Продам видеокарту с каким-то лвл', 'Продам р/с "Видеокарта" -го поколения. Цена: '},
			{'Куплю видеокарту с каким-то лвл', 'Куплю р/с "Видеокарта" -го поколения. Бюджет: '},
			{'Продам охлаждайку', 'Продам р/с "Охлаждающая жидкость для видеокарты". Цена/шт: '},
			{'Куплю охлаждайку', 'Куплю р/с "Охлаждающая жидкость для видеокарты". Бюджет/шт: '},
			{'Продам смазки', 'Продам р/с "Смазки для разгона видеокарты". Цена/шт: '},
			{'Куплю смазки', 'Куплю р/с "Смазки для разгона видеокарты". Бюджет/шт: '},
		},{'Аренда',
			{'Сдам машину', 'Сдам в аренду а/м "". Цена/час: '},
			{'Сдам фуру', 'Сдам в аренду г/м "". Цена/час: '},
			{'Сдам самолет', 'Сдам в аренду с/т "". Цена: '},
			{'Сдам аксик', 'Сдам в аренду а/с "". Цена: '},
			{'Сдам лодку', 'Сдам в аренду л/д "". Цена: '},
			{'Арендую машину', 'Арендую а/м "". Бюджет: '},
			{'Арендую фуру', 'Арендую г/м "". Бюджет: '},
			{'Арендую самолет', 'Арендую с/т "". Бюджет: '},
			{'Арендую аксик', 'Арендую а/с "". Бюджет: '},
			{'Арендую лодку', 'Арендую л/д "". Бюджет: '},
			{'Арендую охранника с доп зп','Арендую услуги охранника с нашивкой "+зп ". Бюджет:'},
		},{'Разное (Az, EXP.,Ларцы)',
			{'Куплю AZ', 'Куплю р/с "Талон на передаваемые AZ-Coins". Бюджет/шт: '},
			{'Продам AZ', 'Продам р/с " Талон на передаваемые AZ-Coins". Цена/шт: '},
			{'Куплю EXP', 'Куплю талон "Передаваемые EXP". Бюджет/шт: '},
			{'Продам EXP', 'Продам р/с "Талон EXP". Цена/шт: '},
			{'Куплю ларец *', 'Куплю р/с "Ларец ". Бюджет/шт: '},
			{'Продам ларец *', 'Продам р/с "Ларец ". Цена/шт: '}
		}
	}
	nHelpEsterSet = {
		{'name','duty','tagCNN','city','server','music'},
		{'имя и фамилия', 'должность', 'тег в депортамент', 'город', 'имя штата', 'Музыкальная заставка'},
		{'Faiser Andreich', 'Стажер', 'СМИ СФ', 'Сан-Фиерро', 'Скоттдейл', '•°•°•°•°Музыкальная заставка Радиостанции г.Сан-Фиерро•°•°•°•°'},
	...
	newsHelpEsters = {
		...
		['events'] = {
			...
			['mathem'] = {
				{'Начать эфир',
					'/d [{tagCNN}] to [СМИ] Занимаю новостную волну, просьба не перебивать!',
					'/news {music}',
					...
					'/news {music}',
					'/d [{tagCNN}] to [СМИ] Освободил новостную волну. Спасибо, что не перебивали!'
			...
			['interpreter'] = {
				{'Начать эфир',
					...
					'/news {tag}До встречи в эфире!!!',
					'/news {music}',
					'/d [{tagCNN}] to [СМИ] Освободил новостную волну. Спасибо за внимание!'
